/*
 ...
 Source Server         : LocalHost_Sa123456
...
CREATE TABLE `app_update`  (
  ...
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态 0:未发布 1:灰度发布 2:全网发布',
  `grayscale_uid` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '灰度uid',
  `file_type` tinyint(1) NULL DEFAULT NULL COMMENT '文件类型 0:本都文件 1:外链',
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'app发布表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `chat_message`  (
  `message_id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  ...
  `contact_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '接收的联系人ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 278 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '聊天消息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会话信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `chat_session_user`  (
  ...
  INDEX `idx_session_id`(`session_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会话用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `group_info`  (
  ...
  `join_type` tinyint(1) NULL DEFAULT NULL COMMENT '0:直接加入 1:管瑝员同意后加入',
...
CREATE TABLE `user_contact`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态 0:非好友 1:好友 2:已删除好友 3:被好友删除 4:已拉黑好友 5:加好友时被好友拉黑 6:加好友后被好友拉黑',
...
CREATE TABLE `user_contact_apply`  (
  ...
  `contact_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '联系人或群组ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 123123129 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '好友申请表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user_info`  (
  ...
  `join_type` tinyint(1) NULL DEFAULT NULL COMMENT '被加好友的方式，0:直接添加  1:同意后添加',
  ...
  `area_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '地区名',
...
CREATE TABLE `user_info_beauty`  (
  ...
  `user_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户ID',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '靓号状态，0:未使用  1:已使用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_key_user_id`(`user_id` ASC) USING BTREE,
  UNIQUE INDEX `idx_key_email`(`email` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1231835138 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '靓号表' ROW_FORMAT = Dynamic;
